...
glm::vec3 sphereCenter(-2.0f, 0.0f, -10.0f);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        sphereMatrix = glm::translate(sphereMatrix, sphereCenter);
        defaultMaterial.SetPropertyValue<glm::vec3>("sphereColor", sphereColor);
        defaultMaterial.SetPropertyValue<glm::vec3>("sphereCenter", sphereCenter);
...
void drawGui()
{
    ...
    ImGui::NewFrame();
    {
        ...
        //TODO 10.1 : Properties for exercise 10.1, you can comment these out for 10.2
        {
            ...
            ImGui::DragFloat3("Box Center", (float*)&boxCenter, 2.0f, -100, 100);
            ImGui::DragFloat3("Box Size", (float*)&boxSize, 1.0f, -100, 100);
